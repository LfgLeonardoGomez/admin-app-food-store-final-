 ...
 */
export function Pagination({ page, totalPages, total, itemLabel, isLoading, onPrev, onNext }: PaginationProps) {
  return (
    <div className="px-6 py-4 bg-surface-container-low flex justify-between items-center border-t border-outline-variant">
      <p className="text-body-md text-secondary">
        Mostrando <strong>{Math.min((page + 1) * 5, total)}</strong> de <strong>{total}</strong> {itemLabel}
      </p>
